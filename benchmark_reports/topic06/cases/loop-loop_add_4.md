...
| TinyFive | PASS | 5 | True | null |

## 性能指标

| 指标 | 当前值 | 基线 | 变化率(%) | 是否退化 |
|---|---:|---:|---:|---|
| 静态汇编指令数 | 15 | 15 | 0.0 | False |
| 编码后机器指令数 | 16 | 16 | 0.0 | False |
| 代码大小(bytes) | 64 | 64 | 0.0 | False |
| TinyFive 动态指令数 | 44 | 44 | 0.0 | False |
| 动态 load | 10 | 10 | 0.0 | False |
| 动态 store | 11 | 11 | 0.0 | False |
| 动态 mul | 0 | 0 | 0.0 | False |
| 动态 add | 13 | 13 | 0.0 | False |
